...
<main class="main-content mt-1">
    <section>
        <div class="page-header max-vh-100">
            <div class="container">
                <div class="row">
                                ...
                                <form role="form" method="POST" action="{{ route('login.perform') }}">
                                    ...
                                    <div class="flex flex-col mb-3">
                                        <input type="email" name="email" class="form-control form-control-lg"
                                            aria-label="Email" placeholder="Masukkan email">
                                        @error('email') <p class="text-danger text-xs pt-1"> {{$message}} </p>@enderror
                                    </div>
                                    <div class="flex flex-col mb-3">
                                        <input type="password" name="password" class="form-control form-control-lg"
                                            aria-label="Password" placeholder="Masukkan password">
                                    ...
                                    <div class="text-center">
                                        <button type="submit"
                                            class="btn bg-primary text-white btn-lg w-100 mt-4 mb-0">Sign
                                            in</button>
                                    </div>
                                </form>
                            </div>
                            <div class="card-footer text-center pt-0 px-lg-2 px-1">
                                <p class="mb-1 text-sm mx-auto">
                                    ...
                                    <a href="{{ route('reset-password') }}"
                                        class="bg-primary text-gradient font-weight-bold">Here</a>
                                </p>
                            </div>
                            <div class="row px-xl-4 px-sm-4 px-3" style="margin-top: -10px;">
                                ...
                                <p class="text-sm text-center mx-auto">
                                    ...
                                    <a href="{{ route('register') }}"
                                        class="bg-primary text-gradient font-weight-bold">Sign up</a>
                                </p>
                            </div>
                        </div>
                    </div>
                    <div
                        ...
                        <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden"
                            style="background-image: url({!! asset('assets/img/amikom.jpg') !!}); background-position-y: 50%; background-position-x: 50%; background-size: cover;">
                            <span class="mask bg-primary opacity-6"></span>
                            <h4 class="mt-5 text-white font-weight-bolder position-relative">"SiUngu"</h4>
                            <p class="text-white position-relative">Sistem aplikasi untuk management organisasi
                                mahasiswa</p>
                        </div>
                    </div>
                </div>
