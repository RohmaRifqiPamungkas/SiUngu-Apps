        ...
        <div class="col-12">
            <div class="card card-profile">
                ...
                <div class="card-header border-0 pt-0 pt-lg-2 pb-4 pb-lg-3">
                    <form action="/update-anggota/{{ $data->id }}" method="POST" role="form">
                        {{ csrf_field() }}
                        <!-- EMAIL -->
                        <div class="form-group col-md-12 justify-content-center">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control form-control-lg"
                                    placeholder="Masukkan nama lengkap" aria-label="Nama" name="nama_siswa"
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <select id="kelas" name="id_kelas" class="form-control form-control-lg">
                                        <option hidden selected value="{{ $data->id_kelas }}">
                                            @if ($data['id_kelas'] == 1)
                                                Divisi Humas
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control form-control-lg" placeholder="+62"
                                    aria-label="noHp" name="no_hp" value="{{ $data->no_hp }}">
                            </div>
