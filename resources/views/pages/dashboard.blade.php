    ...
    <div class="container-fluid py-4">
        ...
        <div class="row mb-4">
            <div class="col-lg-12">
                <div class="alert alert-info" role="alert">
                    <h4 class="alert-heading text-white">Pengumuman Terbaru</h4>
                    <ul class="mb-0 text-white">
                        @forelse ($announcements as $announcement)
                            <li>
                                <a class="mb-0 text-white" href="{{ route('pages.announcements.show', $announcement->id) }}">
                                    {{ $announcement->title }} - {{ $announcement->created_at->format('d M Y') }}
                                </a>
                            </li>
                        @empty
                            <li>Tidak ada pengumuman baru.</li>
                        @endforelse
                    </ul>
                </div>
            </div>
        ...
        <div class="row mt-4">
            <div class="col-lg-12 mb-lg-0 mb-4">
                <div class="card z-index-2 h-100">
                    <div class="card-header pb-0 pt-3 bg-transparent">
                        <h6 class="text-capitalize">Gallery Carousel</h6>
                    </div>
                    <div class="card-body p-3">
                                ...
                                @foreach ($photos as $key => $photo)
                                    <div class="carousel-item @if ($loop->first) active @endif">
                                        <img src="{{ Storage::url($photo->photo_path) }}" class="d-block w-100"
                                            alt="{{ $photo->title }}" style="max-height: 400px; object-fit: cover;">
                                    </div>
                                @endforeach
                            </div>
        ...
        <div class="row mt-4">
                ...
                <div class="card ">
                    <div class="card-header pb-0 p-3">
                        <div class="d-flex justify-content-between">
                            <h6 class="mb-2"><i class="fa fa-arrow-up text-success" style="margin-right: 7px;"></i>Kas
                                Masuk</h6>
                        </div>
                    </div>
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-header pb-0 p-3">
                        <div class="d-flex justify-content-between">
                            <h6 class="mb-2"><i class="fa fa-arrow-down text-danger" style="margin-right: 7px;"></i>Kas
                                Keluar</h6>
                        </div>
                    </div>
                    <div class="table-responsive">
