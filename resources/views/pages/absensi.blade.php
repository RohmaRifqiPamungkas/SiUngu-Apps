...
@section('content')
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-end">
                                            <div class="d-flex justify-content-center align-items-center">
                                                <a class="btn btn-info mt-2" href="{{ route('absen-scan', $item->id) }}"
    ...
    <a class="btn btn-info mt-2" href="{{ route('absen-scan', $item->id_sesi) }}" target="_blank"
                                                            style="margin-right: 5px; font-size: 12px;"><i
                                                                class="fa-solid fa-expand" style="margin-right: 5px;"></i> Scan</a>
@else
    <a class="btn btn-info mt-2" style="margin-right: 5px; font-size: 12px;" disabled><i
                                                                class="fa-solid fa-expand" style="margin-right: 5px;"></i> Scan</a>
    @endif -->

                                                <a class="btn btn-success mt-2"
                                                    href="{{ route('detail-absen', $item->id) }}"
                                                    style="margin-right: 5px; font-size: 12px;"><i
                                                        class="fa-solid fa-circle-info" style="margin-right: 5px;"></i>
                                                    Details</a>
                            ...
                            <div class="card-body">
                                <form action="{{ route('sesi-absensi') }}" method="POST" role="form text-left">
                                    ...
                                    <div class="input-group mb-1">
                                        <textarea name="deskripsi_kegiatan" cols="30" rows="4" class="form-control"
        ...
        function confirmDelete(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = 'delete-sesi/' + id;
                }
            });
        }
    </script>
