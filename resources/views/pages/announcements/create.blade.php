...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Tambah Pengumuman'])
        ...
        <div class="col-12">
            <div class="card card-profile">
                ...
                <div class="card-header border-0 pt-0 pt-lg-2 pb-4 pb-lg-3">
                    <form action="{{ route('pages.announcements.store') }}" method="post" role="form">
                        @csrf
                        <!-- TITLE -->
                        <div class="form-group col-md-12 justify-content-center">
                            <div class="mb-3">
                                <label for="inputTitle" class="form-label" style=" font-size: 14px;">Judul
                                    Pengumuman</label>
                            ...
                            <!-- CONTENT -->
                            <div class="mb-3">
                                <label for="inputContent" class="form-label" style=" font-size: 14px;">Isi
                                    Pengumuman</label>
