...
Route::group(['middleware' => 'auth'], function () {
	...
	Route::get('absen-scan/{id}', [AbsensiController::class, 'scanAbsen'])->name('absen-scan');
	Route::get('update-absen-scan/{id}', [AbsensiController::class, 'scanUpdate'])->name('update-absen-scan');
	Route::get('delete-sesi/{id}', [AbsensiController::class, 'deleteSesi'])->name('delete-sesi');

	Route::post('process-presensi/{id}', [AbsensiController::class, 'processPresensi'])->name('process-presensi');
	Route::get('/detail-absen/{id}', [AbsensiController::class, 'detailAbsen'])->name('detail-absen');

	//coba fitur akhiri sesi
	// Route::get('/selesai-presensi/{id_sesi}', [AbsensiController::class, 'selesaiPresensi'])->name('selesai-presensi');
